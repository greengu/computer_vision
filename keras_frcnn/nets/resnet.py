...
from keras_frcnn.nets.RoiPoolingConv import RoiPoolingConv
from keras_frcnn.nets.FixedBatchNormalization import FixedBatchNormalization


def get_weight_path():

    return 'pre_trained/resnet50_weights_tf_dim_ordering_tf_kernels.h5'
